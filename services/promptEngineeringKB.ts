...
const VIDEO_PROFILES: ModelPromptProfile[] = [
    ...
    // --- Step-Video TI2V ---
    {
        ...
        promptTemplate: 'Portrait-focused music video shot. {characters} {action}. {location}. Camera: {camera}. {lighting}. {style}.',
        tips: 'Optimized for portrait/face-focused shots. Describe facial expressions and subtle movements. Emphasize identity consistency. Good for close-ups and medium shots.',
        modelTags: '',
        nativeConsistency: false,
        outputType: 'video',
    },
